...
<head>
    ...
    <body>
        ...
        <div id="div1div1">
            ...
            <a class="hello"style="position:absolute;top:50px;left:750px;" href="#div3">About</a>
            <a class="hello"style="position:absolute;top:50px;left:950px;" href="#div4">Contact us</a>
            <a class="hello"style="position:absolute;top:50px;left:1150px;" href="signup.php">Signup</a>
            </div>
        <div id="mydiv"> 
 ...
 <p>Let The Medicine Be The Food And Food Be The Medicine</p>
        ...
        <div id="div3">
            ...
            <div id="div3div1">
               ...
               <div id="div3div1div1">
                <p style="position:absolute;">jkddkdb</p>
                   <a href="dietsignup.php" style="color:green;position:absolute;top:200px;">Read More</a>
            </div>
                </div>
            ...
            <p style="font-size:50px;color:white;position:absolute;top:20px;left:180px;">Tips</p>
                <a href="dietsignup.php" style="color:green;position:absolute;top:200px;left:50px;">Read More</a>
            ...
            <div id="div3div2">
               <div id="div3div2div1">    
                ...
                <a href="dietsignup.php" style="color:snow;font-size:20px;position:absolute;top:200px;">Read More</a>
                </div>
            </div>
            </div>
